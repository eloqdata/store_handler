...
private:
    CassSession *session_{nullptr};
    std::vector<
        std::tuple<CassFuture *, CassStatement *, const txservice::TxKey *>>
        futures_;
...
public:
    ...
    bool DeleteOutOfRangeDataInternal(
        const txservice::TableSchema *table_schema,
        const txservice::TableName &table_name,
...
private:
    ...
    struct UpsertTableData : public CallbackData
    {
        ...
        UpsertTableData(
            ...
            const txservice::TableName *table_name,
            const txservice::TableSchema *old_or_new_table_schema,
        ...
        const txservice::TableSchema *schema_;
        ...
        std::atomic<txservice::CcErrorCode> err_code_{
    ...
    struct ScanSliceData
    {
        ...
        txservice::FillStoreSliceCc *load_slice_req_;
        CassSession *session_;
